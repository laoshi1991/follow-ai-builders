...
const USER_DIR = join(homedir(), '.follow-ai-builders');
const CONFIG_PATH = join(USER_DIR, 'config.json');

const FEED_X_URL = 'https://raw.githubusercontent.com/laoshi1991/follow-ai-builders/main/feed-x.json';
const FEED_PODCASTS_URL = 'https://raw.githubusercontent.com/laoshi1991/follow-ai-builders/main/feed-podcasts.json';
const FEED_BLOGS_URL = 'https://raw.githubusercontent.com/laoshi1991/follow-ai-builders/main/feed-blogs.json';
...
async function main() {
  ...
  //
  // If the user has a custom prompt at ~/.follow-ai-builders/prompts/<file>,
